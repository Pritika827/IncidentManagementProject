...
import com.transline.servicesImp.UserServiceImpl;
...
//    private UserService userService;
    ...
    public ResponseEntity<JwtResponse> login(@RequestBody JwtRequest request) {
        ...
        this.doAuthenticate(request.getUserName(), request.getPassword(),request.getCmpCd());
    ...
    private void doAuthenticate(String email, String password,String cmpCd) {
